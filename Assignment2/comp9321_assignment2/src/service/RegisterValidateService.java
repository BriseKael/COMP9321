...
import utensil.EmailUtil;
import utensil.MD5Util;
...
public class RegisterValidateService {
    ...
    public void processregister(UserModel user,String basePath) {
        ...
        //发送邮件
        EmailUtil.send(user.getEmail(), sb.toString());
...
//        //数据访问层，通过email获取用户信息
//        //UserModel user = userDao.query(email);
//        //验证用户是否存在
//        if (user != null) {
//            //验证用户激活状态
//            if (user.getStatus() == 0) {
